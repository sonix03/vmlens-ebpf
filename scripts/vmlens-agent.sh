...
start_agent() {
  ...
  export CONNECTIVITY_PROBE_ENABLED="${CONNECTIVITY_PROBE_ENABLED:-true}"
  export CONNECTIVITY_PROBE_INTERVAL="${CONNECTIVITY_PROBE_INTERVAL:-5s}"
  ...
  export IGNORE_PORTS="${IGNORE_PORTS:-18080,18081,18082,30033,30035}"
